...
export default function ChatBotScreen() {
    ...
    return (
        <View style={{ alignItems: 'center', paddingTop: 90 }}>
            ...
            <Text
                style={[{ color: selectedChatFace?.primary }, { fontSize: 30, fontWeight: 'bold' }]}>
            ...
            <Text
                style={{ marginTop: 30, fontSize: 25 }}>How Can I help you?
            </Text>
            ...
            <TouchableOpacity
                onPress={() => navgitaion.navigate('Chat', { selectedFace: selectedChatFace })}
